...
function loading(){
    ...
    inner+='</div><br><div class="row"><div class="col-sm-4"></div><div class="col-sm-4"><button class="btn btn-block btn-danger" onclick="saveCharge()">Enregistrer</button></div><div class="col-sm-4"></div></div>';
...
function saveCharge(){
    ...
    axios.post("{{route('register.saveNewTypeCharge')}}",formData)
    .then(function(res){

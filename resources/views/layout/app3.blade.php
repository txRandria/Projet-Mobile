...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-warning text-dark mt-4">
                    <div class="container">
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <img width="50" src="{{ asset('icon/icons8-ajouter-la-base-de-données-96.png') }}"><b>Référence</b></a>
                            ...
                            <img width="35" src="{{ asset('icon/icons8-menu-512.png') }}"><b> Declaration des pertes</b></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="javascript:;" onclick="Ref2()">
                            <img width="35" src="{{ asset('icon/icons8-menu-512.png') }}"><b> Prix d'achat</b></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="javascript:;" onclick="Ref3()">
                            <img width="35" src="{{ asset('icon/icons8-menu-512.png') }}"><b> declarations des charges</b></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('app.showTraitement')}}">
                            <img width="35" src="{{ asset('icon/icons8-usine-96.png') }}"><b> Process</b></a>
                          </li>
                        </ul>
                        <ul class="navbar-nav ml-lg-auto">
                            <li class="nav-item dropdown">
                            ...
                            <img width="35" src="{{ asset('icon/icons8-record-96.png') }}"><b> Les enregistrements</b></a>
                              ...
                              <a class="dropdown-item" href="javascript:;" onclick="ViewStocks()">
                                <img width="35" src="{{ asset('icon/icons8-portefeuille-investissement-96.png') }}"><b> Situation</b></a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item" href="javascript:;" onclick="Inventaire()">
                                <img width="35" src="{{ asset('icon/icons8-qr-code-96.png') }}"><b> Etiquette & Inventaire</b></a>
                            </div>
                          </li>
                        </ul>
                        ...
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <img width="35" src="{{ asset('icon/icons8-plus-128.png') }}"><b> Ajouter résultats analyses</b></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="javascript:;" onclick="launchSaisiDescription()">
                            <img width="35" src="{{ asset('icon/icons8-plus-128.png') }}"><b> Ajouter une description</b></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('app.getIGUSuiviQualite')}}">
                            <img width="35" src="{{ asset('icon/icons8-menu-512.png') }}"><b> Suivi</b></a>
                          </li>
                        </ul>
                        ...
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <a class="dropdown-item" href="javascript:;" onclick="getOperationGUI()">
                              <img width="35" src="{{ asset('icon/icons8-graphique-combiné-96.png') }}"><b>Production</b>
                            </a>
                            </div>
                          </li>
                        </ul>
    ...
    <script type="text/javascript">
        ...
        function Ref(){
            window.location.href = "{{ route('app.viewOut')}}";   //app.lot       
        }
        function Ref2(){
            window.location.href = "{{ route('app.viewPrix')}}";   //app.lot       
        }
        function Ref3(){
            window.location.href = "{{ route('app.viewCharge')}}";   //app.lot       
        }
        ...
        function launchSaisiDescription(){
            window.location.href = "{{route('app.getIGUDescription')}}"; 
        }                                                                               
    </script>
</body>
</html>
